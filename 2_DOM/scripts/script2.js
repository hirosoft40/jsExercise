...
navDiv.setAttribute("class","navSetting fixed-top p-3");
navA1.textContent = "HighOnCoding";
navUl.setAttribute("class", "nav navbar-")
...
container.setAttribute('class', 'container pt-5')
...
secondRowh3.setAttribute("class", "mb-2");
...
thirdRowh3.setAttribute("class", "mb-2");
